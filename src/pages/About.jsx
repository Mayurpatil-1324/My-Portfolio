...
const About = () => {
  ...
  const journey = [
    {
      ...
      description:
        "Completed BCA from NMU University, Jalgaon, building a strong foundation in computer science and programming.",
    },
    {
      icon: <FaCode className="text-2xl" />,
      title: "Frontend & Backend Skills",
      description:
        "Started with HTML, CSS, JavaScript, then mastered React.js, Redux, Node.js, Express, and MongoDB for full-stack development.",
    },
    {
  ...
  const skills = [
    {
      category: "Frontend",
      items: ["React.js", "JavaScript", "HTML", "CSS", "Tailwind", "Ant Design"],
    },
    {
      category: "Backend",
      items: ["Node.js", "Express.js", "MongoDB", "REST APIs", "MERN Stack"],
    },
    {
      category: "Tools & Platforms",
      items: ["Git", "Postman", "Jira", "Bitbucket", "Vercel", "Render"],
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-lg md:text-xl max-w-2xl mx-auto ${textPrimary}`}>
            React.js Developer with 1.7 years of experience building responsive, scalable, and user-focused web applications. Skilled in React.js, Redux, Tailwind CSS, Ant Design, HTML, CSS, JavaScript, and REST APIs. Passionate about clean code, modern web technologies, and creating high-quality digital experiences.
          </p>
        </div>

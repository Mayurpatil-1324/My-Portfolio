  ...
  const contacts = [
    {
      ...
      label: "Email",
      value: "mayurapatil0106@gmail.com",
    },
    {
      icon: <Mail className="w-5 h-5" />,
      label: "Alternate Email",
      value: "itzpatilmayur@gmail.com",
    },
    {
  ...
  const socials = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/Mayurpatil-1324",
    },
    {
      icon: <Linkedin className="w-5 h-5" />,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/mayurpatil13498",
    },
    {
      icon: <Instagram className="w-5 h-5" />,
      label: "Instagram",
      link: "https://instagram.com/itzpatilmayur",
    },
    {
      icon: <MessageCircle className="w-5 h-5" />,
      label: "WhatsApp",
      link: "https://wa.me/7066923036",
    },
    {
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
          <a
            href="mailto:itzpatilmayur@gmail.com"

...
const categories = [
  
  {
    ...
    skills: [
      ...
      { name: "Express.js", level: 78, icon: "⚙️" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Cross-Browser Compatibility", level: 87, icon: "🧩" },
      { name: "Lazy Loading", level: 82, icon: "💤" },
      { name: "Code Splitting", level: 80, icon: "⚙️" },
    ],
  },
  {
    title: "Testing & Quality",
    skills: [
      { name: "Functional Testing", level: 85, icon: "🧪" },
      { name: "UI Testing", level: 80, icon: "🧩" },
      { name: "Bug Tracking", level: 83, icon: "🐞" },
      { name: "Postman API Testing", level: 82, icon: "📬" },
    ],
  },
  {

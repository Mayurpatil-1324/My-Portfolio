...
const Home = () => {
  ...
  const roles = [
    { icon: FaLaptopCode, title: "Front-End Developer", desc: "Crafting responsive and interactive UIs" },
    { icon: FaReact, title: "React.js Developer", desc: "Building modern and dynamic web apps" },
    { icon: FaPalette, title: "UI/UX Designer", desc: "Designing clean and user-friendly interfaces" },
    { icon: FaCode, title: "Next.js Developer", desc: "Creating fast and SEO-optimized web applications" },
    { icon: FaBug, title: "Manual Tester", desc: "Performing functional and UI testing to ensure quality" },
    { icon: FaSearch, title: "SEO & Brand Setup Expert", desc: "Optimizing Google Business and social presence" },
  ];
  return (
